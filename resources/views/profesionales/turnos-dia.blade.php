        ...
        @foreach($turnos as $turno)
            <div class="bg-white shadow-lg p-6 mb-4 rounded-lg border border-gray-200">
                ...
                <form method="POST" action="{{ route('profesional.historial.agregar') }}" class="mt-4">
                    ...
                    <button type="submit" class="mt-3 bg-pink-500 text-white px-4 py-2 rounded-lg hover:bg-pink-600 focus:outline-none focus:ring-2 focus:ring-pink-300">Guardar al Historial</button>
                </form>
